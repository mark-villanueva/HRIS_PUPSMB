...
class EmployeesPolicy
{
    ...
    {
        return $user->can('view_any_employees');
    }
    ...
    {
        return $user->can('delete_any_employees');
    }
    ...
    {
        return $user->can('force_delete_employees');
    }
    ...
    {
        return $user->can('force_delete_any_employees');
    }
    ...
    {
        return $user->can('restore_employees');
    }
    ...
    {
        return $user->can('restore_any_employees');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Employees $employees): bool
    {
        return $user->can('replicate_employees');
    }
    ...
    {
        return $user->can('reorder_employees');
    }
}
